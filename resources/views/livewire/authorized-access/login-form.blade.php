<form wire:submit.prevent="submit" class="ap-login-form" novalidate autocomplete="off">
    ...
    <div class="ap-login-field">
        <label class="ap-login-label">{{ __('Login nebo e-mail:') }}</label>
    ...
    <div class="ap-login-field">
        <label class="ap-login-label">{{ __('Heslo:') }}</label>
    ...
    <div class="ap-login-btn-row">
        <button type="submit" class="form-submit-button" wire:loading.attr="disabled" wire:target="submit">
            <span wire:loading.remove wire:target="submit">{{ __('Přihlásit se') }}</span>
            <span wire:loading wire:target="submit">{{ __('Přihlašuji…') }}</span>
        </button>
    </div>
