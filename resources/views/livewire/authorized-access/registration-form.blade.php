    ...
    <form wire:submit.prevent="submit" class="space-y-5" novalidate>
        ...
        <div class="grid gap-5 md:grid-cols-2">
            ...
            <div>
                ...
                <input wire:model.defer="password_confirmation" type="password" class="w-full rounded-lg border border-slate-300 px-4 py-3 focus:border-slate-500 focus:outline-none" />
            </div>
        </div>
